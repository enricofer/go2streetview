...
<qgis version="2.18.10" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="pitch">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="outline_color" v="0,170,255,0"/>
        ...
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="90"/>
          <prop k="angle_dd_active" v="1"/>
          <prop k="angle_dd_expression" v="heading + 90"/>
  ...
  <displayfield>&lt;b>Google Streetview snapshot: [% "date" %] [% "lon" %]E [% "lat" %]N &lt;/b>&lt;br/>&lt;b>Address: [% "address" %]&lt;/b>&lt;br/>&lt;b>Note:  [%notes%]&lt;/b></displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="pitch"/>
      <column width="-1" hidden="0" type="field" name="address"/>
      <column width="97" hidden="0" type="field" name="notes"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="pitch" expression=""/>
